...
dict_word, matrix_binary_all, matrix_binary_poem, matrix_binary_contents, dict_word_pinyin, dict_pinyin_word = process_data()
...
while flag_continue:
    ...
    leixing = input('输入查询类型，0：binary；1：zone; 2 : fuzzy; 3: ranked; 4：zone+ranked\n')
